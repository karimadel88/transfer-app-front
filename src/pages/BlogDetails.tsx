        ...
        <article className="bg-white rounded-3xl overflow-hidden shadow-lg border border-gray-100">
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="mt-12 bg-green-50 border border-green-100 rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div>
                <h3 className="font-bold text-green-800 text-lg mb-1">هل لديك استفسار حول هذه المقالة؟</h3>
                <p className="text-green-600 text-sm">تواصل معنا مباشرة عبر الواتساب للإجابة على جميع تساؤلاتك.</p>
              </div>
              <a
                href={`https://wa.me/201009531974?text=${encodeURIComponent('مرحباً، لدي استفسار بخصوص مقالة: ' + blog.title + '\n\nرابط المقالة:\n' + window.location.href + '\n\n(تم التواصل من خلال موقع الفتح https://elfat7.cloud/)')}`}
                target="_blank"
