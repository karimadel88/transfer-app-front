    ...
    <PageLayout>
      <div className="container mx-auto px-4 py-12 max-w-5xl" dir="rtl">
        <div className="text-center mb-12">
          <h1 className="text-3xl font-black text-brand-dark mb-4">العروض</h1>
          <p className="text-gray-500">أحدث العروض الحصرية</p>
        </div>
        
        {offers.length === 0 ? (
          <p className="text-center text-gray-500 py-10">لا توجد عروض حالياً</p>
        ) : (
            ...
            {offers.map(offer => (
              ...
              >
                ...
                <div className="p-5 flex-1 flex flex-col">
                  ...
                  <h3 className="font-bold text-lg text-brand-dark mb-2 line-clamp-2">{offer.title}</h3>
